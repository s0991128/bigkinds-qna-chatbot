  ...
  return (
    <main className="history-page">
      <header className="history-header">
        <Link className="site-brand" href="/"><span className="brand-tile">B</span><span><strong>BIG KINDS</strong><small>뉴스빅데이터 분석서비스</small></span></Link>
        <Link className="back-link" href="/">← 챗봇으로 돌아가기</Link>
      </header>
