...
export function createLookupReplyDraft(currentCase: ArticleLookupCase, result: ArticleLookupResultStatus | null) {
  ...
  return "안녕하세요.\n한국언론진흥재단 뉴스빅데이터팀입니다.\n\n문의주신 기간·언론사·검색어를 기준으로 빅카인즈에서 관련 자료를 확인하는 방법을 검토하였으나, 현재 확인한 검색조건에서는 요청하신 자료를 확인하지 못했습니다.\n\n빅카인즈는 협약 언론사로부터 제공받은 기사 데이터를 기반으로 서비스하고 있어, 과거 신문의 모든 지면이나 지면 내 별도 박스·명단 등의 내용이 검색되지 않을 수 있습니다.\n\n" + pageNotice + "\n\n감사합니다.\n한국언론진흥재단 뉴스빅데이터팀 드림";
}
