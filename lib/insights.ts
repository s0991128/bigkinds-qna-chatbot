...
export const INSIGHT_EVENT_TYPES = [
  ...
  "ROUTE_HARD_RULE", "ROUTE_DETERMINISTIC", "ROUTE_KNOWLEDGE", "ROUTE_LLM", "ANSWER_INTERNAL_ENGINE", "ANSWER_LLM_GENERATED", "RECOMMENDATION_CONTEXT_RULE", "RECOMMENDATION_LLM_RERANK",
] as const;
