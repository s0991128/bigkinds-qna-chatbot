...
export const INSIGHT_EVENT_TYPES = [
  ...
  "SERVICE_OVERVIEW_USED", "SERVICE_FACT_USED", "SERVICE_GUIDE_USED", "MANUAL_GUIDE_USED", "SUPPORT_TRIAGE_USED", "OPEN_API_REDIRECT", "OUT_OF_SCOPE", "NO_CONFIDENT_MATCH", "GEMINI_UNAVAILABLE",
